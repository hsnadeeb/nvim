return function()
  ...
  require("nvim-tree").setup({
    ...
    view = { width = 35, side = "left", preserve_window_proportions = true, number = false, relativenumber = false, signcolumn = 'yes' },
    renderer = {
      group_empty = true, highlight_git = true, full_name = false,
      highlight_opened_files = 'all', highlight_modified = 'icon',
      root_folder_label = ':~:s?$?/..?',
      indent_width = 2,
      ...
      icons = {
        ...
        glyphs = {
          default = '', symlink = '', bookmark = '󰆤', modified = '●',
    ...
    actions = {
      use_system_clipboard = true, change_dir = { enable = true, global = true },
      expand_all = { max_folder_discovery = 300, exclude = { 'node_modules', 'target', 'build' } },
      open_file = { quit_on_open = false, resize_window = true, window_picker = { enable = true, chars = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890' } },
    },
  ...
  map("n", "<leader>e", function()
    if vim.bo.filetype == 'NvimTree' then vim.cmd('wincmd p')
